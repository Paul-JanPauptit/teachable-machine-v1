...
class LearningSection {
  ...
  updateLanguage() {
    ...
    function updateText(querySelector, text) {
      const elements = parent.querySelectorAll(querySelector);
      for (let i = 0; i < elements.length; i++)
        elements[i].innerHTML = text[GLOBALS.language];
    }
    updateText(".confidence__status", {
      en: "Confidence",
      de: "Zuversicht"
    });
    updateText(".examples__caption", {
      en: "examples",
      de: "Beispiele"
    });
    updateText(".button--color-green .button__content--small", {
      en: "Train Green",
      de: "Trainiere Gr&Uuml;n"
    });
    updateText(".button--color-purple .button__content--small", {
      en: "Train Purple",
      de: "Trainiere Violett"
    });
    updateText(".button--color-orange .button__content--small", {
      en: "Train Orange",
      de: "Trainiere Orange"
    });
